...
class StockQuant(models.Model):
    ...
    length = fields.Float(string='Length(in mm)',compute='_get_value_from_formula', digits=dp.get_precision('Stock Weight'))
    weight = fields.Float(string='Weight(in Kg)',compute='set_length', digits=dp.get_precision('Stock Weight'))

    @api.depends('product_id','qty')
    def set_length(self):
        for res in self:
            if res.product_id.is_eng_product:
                # res.length = res.qty
                res.weight = res.qty
    ...
    def _get_value_from_formula(self):
        for res in self:
            if res.product_id.is_eng_product:
                ...
                #                 res.weight = 0.00
                #             else:
                #                 weight = 0.000001 * 7800 * res.product_id.thickness * res.product_id.width * res.length
                ...
                #                 weight = (0.000001 * 7800 * res.length * (af * af))
                #                 res.weight = weight / 1000
                #
                ...
                #             else:
                #                 weight = (0.000001 * (
                #                         res.product_id.side1 + res.product_id.side2 - 2 * res.product_id.width) * 2 * res.product_id.width *2700)
                #                 res.weight = weight / 1000
                #
                #
                #     # ********************************** for 5th material**************************
                    ...
                    if res.product_id.material == 'carbon':
                        if res.product_id.shape == 'sheet_plate' or res.product_id.shape == 'coil':
                            if res.product_id.thickness < 0.01:
                                ...
                                res.length = (res.weight / (
                                            0.000001 * 7860 * res.product_id.thickness * res.product_id.width)) * 1000
                        ...
                        if res.product_id.shape == 'angle_bar':
                            if res.product_id.thickness < 0.0001:
                                ...
                                res.length = (res.weight / (0.000001 * (
                                            res.product_id.leg1 + res.product_id.leg2 - res.product_id.thickness) * res.product_id.thickness * 7800)) * 1000
                        ...
                        if res.product_id.shape == 'round/pipe':
                            if res.product_id.outer_diameter < 0.0001:
                                ...
                                res.length = (res.weight / (0.00000314 * 7800 * (
                                            res.product_id.outer_diameter - res.product_id.width) * res.product_id.width)) * 1000
                        ...
                        if res.product_id.shape == 'square':
                            if res.product_id.side1 < 0.0001:
                                ...
                                res.length = (res.weight / (0.000001 * (
                                            res.product_id.side1 + res.product_id.side2 - 2 * res.product_id.width) * 2 * res.product_id.width * 7800)) * 1000
                        ...
                        if res.product_id.shape == 'sheet_plate':
                            if res.product_id.thickness < 0.01:
                                ...
                                res.length = (res.weight * 1000) / (
                                            0.000001 * 7900 * res.product_id.thickness * res.product_id.width)
                        ...
                        if res.product_id.shape == 'angle_bar':
                            if res.product_id.thickness < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.000001 * (
                                            res.product_id.leg1 + res.product_id.leg2 - res.product_id.thickness) * res.product_id.thickness * 7900)
                        ...
                        if res.product_id.shape == 'round/pipe':
                            if res.product_id.outer_diameter < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.00000314 * 7900 * (
                        ...
                        if res.product_id.shape == 'square':
                            if res.product_id.side1 < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.000001 * (
                                            res.product_id.side1 + res.product_id.side2 - 2 * res.product_id.width) * 2 * res.product_id.width)
                    ...
                    # ************************************Third material**************************************
                        ...
                        if res.product_id.shape == 'sheet_plate':
                            if res.product_id.thickness < 0.01:
                                ...
                                res.length = (res.weight * 1000) / (
                                            0.000001 * 8470 * res.product_id.thickness * res.product_id.width)
                        ...
                        if res.product_id.shape == 'round/pipe':
                            if res.product_id.outer_diameter < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.00000314 * 8470 * (
                                            res.product_id.outer_diameter - res.product_id.width) * res.product_id.width)
                        ...
                        if res.product_id.shape == 'square':
                            if res.product_id.side1 < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.000001 * (
                                            res.product_id.side1 + res.product_id.side2 - 2 * res.product_id.width) * 2 * res.product_id.width * 8470)
                    ...
                    # ******************************************** for 4th material*****************************
                        ...
                        if res.product_id.shape == 'sheet_plate':
                            if res.product_id.thickness < 0.01:
                                ...
                                res.length = res.weight / (
                                            0.000001 * 2700 * res.product_id.thickness * res.product_id.width)
                        if res.product_id.shape == 'round':
                            if res.product_id.diameter < 0.001:
                                res.length = 0.00
                            else:
                        ...
                        if res.product_id.shape == 'angle_bar':
                            if res.product_id.thickness < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.000001 * (
                                            res.product_id.leg1 + res.product_id.leg2 - res.product_id.thickness) * res.product_id.thickness * 2700)
                        ...
                        if res.product_id.shape == 'round/pipe':
                            if res.product_id.outer_diameter < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.00000314 * 2700 * (
                                            res.product_id.outer_diameter - res.product_id.width) * res.product_id.width)
                    ...
                    # ********************************** for 5th material**************************
                        ...
                        if res.product_id.shape == 'sheet_plate':
                            if res.product_id.thickness < 0.01:
                                ...
                                res.length = res.weight / (
                                            0.000001 * 5000 * res.product_id.thickness * res.product_id.width)
                        ...
                        if res.product_id.shape == 'angle_bar':
                            if res.product_id.thickness < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.000001 * (
                                            res.product_id.leg1 + res.product_id.leg2 - res.product_id.thickness) * res.product_id.thickness * 5000)
                        ...
                        if res.product_id.shape == 'square':
                            if res.product_id.side1 < 0.0001:
                                ...
                                res.length = (res.weight * 1000) / (0.000001 * (
                                        res.product_id.side1 + res.product_id.side2 - 2 * res.product_id.width) * 2 * res.product_id.width * 5000)
